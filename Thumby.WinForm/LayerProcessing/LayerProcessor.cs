...
{
    public static void ProcessLayers(Bitmap bitmap, Graphics graphics, List<ICanvasLayer> canvasLayers)
    {
        ...
        for (int i = canvasLayers.Count - 1; i >= 0; i--)
        {
            ...
            if (item is ThumbnailText thumbnailText)
                ThumbnailRenderer.ProcessTextLayer(graphics, thumbnailText);
